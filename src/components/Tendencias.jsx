...
const Tendencias = () => {
  ...
  return (
    <div className="container h-[380px] sm:h-auto mx-auto mt-10 sm:mt-20 px-4 md:px-16 py-11 bg-[#DC1E0F] relative">
      ...
      <style jsx global>{`
        ...
        .swiper-pagination {
          ...
          bottom: -3px !important; /* Mueve la paginación un poco más abajo */
